...
namespace Ecommerce.DataAccess.Migrations
{
    ...
    [Migration("20250406142252_Payment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Inventory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.CartItem", b =>
                {
                    b.HasOne("Ecommerce.Models.Entity.Cart", "Cart")
                        .WithMany("CartItem")
                        .HasForeignKey("CartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ecommerce.Models.Entity.Product", "Product")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Inventory", b =>
                {
                    b.HasOne("Ecommerce.Models.Entity.Product", "Product")
                        .WithOne("Inventory")
                        .HasForeignKey("Ecommerce.Models.Entity.Inventory", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Payment", b =>
                {
                    ...
                    b.HasOne("Ecommerce.Models.Entity.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce.Models.Entity.Product", b =>
                {
                    b.HasOne("Ecommerce.Models.Entity.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ecommerce.Models.Entity.User", "Seller")
                        .WithMany()
